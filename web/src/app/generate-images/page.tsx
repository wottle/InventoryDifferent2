          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <button
                ...
                disabled={isRunning}
                className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded border border-[var(--border)] text-[var(--foreground)] bg-[var(--card)] hover:bg-[var(--muted)] disabled:opacity-50 transition-colors"
              >
