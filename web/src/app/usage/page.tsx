    ...
    return (
      <div className="min-h-screen bg-[var(--background)] p-4 sm:p-6">
        <div className="mx-auto max-w-4xl">
          <LoadingPanel title="Loading usage data…" subtitle="Tallying things up" />
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[var(--background)] p-4 sm:p-6">
      <div className="mx-auto max-w-4xl space-y-6">
        <header className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-light text-[var(--foreground)]">System Usage</h1>
            <p className="text-sm text-[var(--muted-foreground)]">Overview of your inventory data</p>
          </div>
          <Link
            href="/"
        ...
        <section className="rounded border border-[var(--border)] bg-[var(--card)] p-6 card-retro">
          <h2 className="mb-4 text-lg font-semibold text-[var(--foreground)]">Data Counts</h2>
          
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
              <div className="text-xs text-[var(--muted-foreground)]">Devices</div>
              <div className="mt-1 text-3xl font-light tabular-nums text-[var(--foreground)]">
                {usage?.deviceCount ?? 0}
              </div>
            </div>
            <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
              <div className="text-xs text-[var(--muted-foreground)]">Images</div>
              <div className="mt-1 text-3xl font-light tabular-nums text-[var(--foreground)]">
                {usage?.imageCount ?? 0}
              </div>
            </div>
            ...
            <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
              <div className="text-xs text-[var(--muted-foreground)]">Maintenance Tasks</div>
              <div className="mt-1 text-3xl font-light tabular-nums text-[var(--foreground)]">
                {usage?.taskCount ?? 0}
              </div>
            </div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3">
            ...
            <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
              <div className="text-xs text-[var(--muted-foreground)]">Templates</div>
              <div className="mt-1 text-2xl font-light tabular-nums text-[var(--foreground)]">
                {usage?.templateCount ?? 0}
              </div>
            </div>
            <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
              <div className="text-xs text-[var(--muted-foreground)]">Tags</div>
              <div className="mt-1 text-2xl font-light tabular-nums text-[var(--foreground)]">
                {usage?.tagCount ?? 0}
              </div>
            </div>
        ...
        <section className="rounded border border-[var(--border)] bg-[var(--card)] p-6 card-retro">
          <h2 className="mb-4 text-lg font-semibold text-[var(--foreground)]">Storage</h2>
          
          <div className="rounded border border-[var(--border)] p-4 bg-[var(--background)]">
            <div className="text-xs text-[var(--muted-foreground)]">Total Image Storage</div>
            <div className="mt-1 text-3xl font-light tabular-nums text-[var(--foreground)]">
              {formatBytes(usage?.totalStorageBytes ?? 0)}
            </div>
            <div className="mt-1 text-xs text-[var(--muted-foreground)]">
              {(usage?.totalStorageBytes ?? 0).toLocaleString()} bytes
            </div>
          </div>
        </section>
      </div>
