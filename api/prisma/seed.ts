...
async function main() {
    ...
    const timelineEventData = [
        ...
        { year: 1984, title: "System 1.0 released", description: "System 1.0 ships with the original Macintosh — a single-tasking graphical OS with the Finder, MacPaint, and MacWrite. It fits on a 400K floppy and sets the template for personal computing GUIs.", type: "apple", sortOrder: 1 },
        { year: 1984, title: "Mac 512K (Fat Mac)", description: "Apple releases the Macintosh 512K, quadrupling RAM over the original and earning the nickname 'Fat Mac'.", type: "apple", sortOrder: 2 },
        ...
        { year: 1986, title: "System 3.0 released", description: "System 3.0 introduces the Hierarchical File System (HFS), replacing the flat MFS and allowing folders within folders — a foundational change that made the Mac's file system practical for hard drives.", type: "apple", sortOrder: 1 },
        ...
        { year: 1988, title: "System 6.0 released", description: "System 6.0 integrates MultiFinder, allowing multiple applications to run simultaneously for the first time. Lean, stable, and fast, it became the definitive OS for the classic compact Mac era.", type: "apple", sortOrder: 0 },
        { year: 1988, title: "NeXT Computer unveiled", description: "Steve Jobs unveils the NeXT Computer — an elegant workstation with an optical drive and object-oriented OS that later becomes the foundation of macOS.", type: "tech", sortOrder: 1 },
        ...
        { year: 1994, title: "Mac OS 7.5 released", description: "Mac OS 7.5 is the most feature-complete System 7 release, adding Apple Guide, WindowShade, and Macintosh Drag and Drop. Apple later made it a free download — a rare act of generosity that kept older Macs useful well into the late 90s.", type: "apple", sortOrder: 1 },
        ...
        { year: 1997, title: "Mac OS 7.6 released", description: "Mac OS 7.6 is the first release officially branded 'Mac OS' rather than 'System', marking the end of the classic System Software naming era. It also dropped support for 68000-based Macs, signaling Apple's move forward.", type: "apple", sortOrder: 0 },
        { year: 1997, title: "Jobs returns as CEO", description: "Steve Jobs becomes Apple's interim CEO. He axes Newton, consolidates the product line to four quadrants, and launches the Think Different campaign.", type: "apple", sortOrder: 1 },
        { year: 1997, title: "Mac OS 8 released", description: "Mac OS 8 ships as a major update Apple could sell separately, bypassing Macintosh clone license agreements and generating $100 million in its first two weeks — effectively ending the clone era.", type: "apple", sortOrder: 2 },
        ...
        { year: 1999, title: "Mac OS 9 released", description: "Mac OS 9 arrives as the last major Classic Mac OS release, adding Keychain, Sherlock 2 internet searching, and multi-user support — later serving as the compatibility layer inside Mac OS X's Classic environment.", type: "apple", sortOrder: 1 },
